...
@section('extra-styles')
    <style>
        ...
        .kpi-icon.gd {
            background: linear-gradient(135deg, #C27803, #EAB308);
            box-shadow: 0 4px 14px rgba(194, 120, 3, .28);
        }
                ...
                <div class="col-md-5" data-aos="fade-right">
                    <div class="panel">
                        <div class="panel-hd">
                            ...
                            <div class="panel-opts" style="position:relative;">
                                <i data-lucide="more-horizontal" id="chartMenu1Toggle" style="cursor:pointer;"></i>
                                <div id="chartMenu1Drop" style="display:none;position:absolute;right:0;top:100%;background:#fff;border:1px solid #E5E9F2;border-radius:10px;box-shadow:0 6px 20px rgba(0,0,0,.1);padding:.35rem;min-width:150px;z-index:20;">
                                    <a href="{{ route('admin.students.index') }}" style="display:flex;align-items:center;gap:.5rem;padding:.42rem .75rem;border-radius:7px;color:#374151;font-size:.8rem;font-weight:500;text-decoration:none;transition:background .12s;">
                                        <i data-lucide="graduation-cap" style="width:13px;height:13px;stroke:#1B4332;"></i>View Students
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-center gap-4 mt-3">
                            <div class="d-flex align-items-center gap-2" style="font-size:.77rem;color:#64748B;">
                                <span
                                    style="width:10px;height:10px;border-radius:3px;background:linear-gradient(135deg,#1B4332,#2D6A4F);display:inline-block;flex-shrink:0;"></span>
                                Active ({{ $activeStudents }})
                            </div>
                            <div class="d-flex align-items-center gap-2" style="font-size:.77rem;color:#64748B;">
                                <span
                                    style="width:10px;height:10px;border-radius:3px;background:#E2E8F0;display:inline-block;flex-shrink:0;"></span>
                ...
                <div class="col-md-7" data-aos="fade-up">
                    <div class="panel">
                        <div class="panel-hd">
                            ...
                            <div class="panel-opts" style="position:relative;">
                                <i data-lucide="more-horizontal" id="chartMenu2Toggle" style="cursor:pointer;"></i>
                                <div id="chartMenu2Drop" style="display:none;position:absolute;right:0;top:100%;background:#fff;border:1px solid #E5E9F2;border-radius:10px;box-shadow:0 6px 20px rgba(0,0,0,.1);padding:.35rem;min-width:160px;z-index:20;">
                                    <a href="{{ route('admin.users.index') }}" style="display:flex;align-items:center;gap:.5rem;padding:.42rem .75rem;border-radius:7px;color:#374151;font-size:.8rem;font-weight:500;text-decoration:none;transition:background .12s;">
                                        <i data-lucide="users" style="width:13px;height:13px;stroke:#1B4332;"></i>Manage Users
                                    </a>
                                    <a href="{{ route('admin.guardians.index') }}" style="display:flex;align-items:center;gap:.5rem;padding:.42rem .75rem;border-radius:7px;color:#374151;font-size:.8rem;font-weight:500;text-decoration:none;transition:background .12s;">
                                        <i data-lucide="heart-handshake" style="width:13px;height:13px;stroke:#C27803;"></i>View Guardians
                                    </a>
                                    <a href="{{ route('admin.enrollments.index') }}" style="display:flex;align-items:center;gap:.5rem;padding:.42rem .75rem;border-radius:7px;color:#374151;font-size:.8rem;font-weight:500;text-decoration:none;transition:background .12s;">
                                        <i data-lucide="clipboard-check" style="width:13px;height:13px;stroke:#0F766E;"></i>View Enrollments
                                    </a>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        var centerTextPlugin = {
            ...
            beforeDraw: function(chart) {
                ...
                var active = chart.data.datasets[0].data[0] || 0;
                ...
                ctx.font = 'bold 26px Inter,sans-serif'; ctx.fillStyle = '#0F172A';
                ctx.fillText(active, cx, cy - 11);
                ctx.font = '600 11px Inter,sans-serif'; ctx.fillStyle = '#64748B';
                ctx.fillText('Active (' + pct + '%)', cx, cy + 11);
                ctx.restore();
            }
        };
        ...
        /* ── Student status donut ────────────────────────── */
        var donutChart = new Chart(document.getElementById('studentStatusChart'), {
            type: 'doughnut',
            data: {
                ...
                datasets: [{
                    ...
                    hoverBackgroundColor: ['#2D6A4F', '#CBD5E1'],
                    borderColor: '#fff',
                    borderWidth: 3,
                    hoverOffset: 10,
                }]
            ...
            options: {
                ...
                onClick: function(e, els) {
                    if (els.length) window.location.href = '{{ route("admin.students.index") }}';
                }
            }
        });

        /* ── People overview bar ─────────────────────────── */
        var barCtx = document.getElementById('peopleChart').getContext('2d');
        ...
        var barChart = new Chart(barCtx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: [
                        mkGrad(barCtx, '#1B4332', '#2D6A4F'),
                        mkGrad(barCtx, '#D97706', '#EAB308'),
                        mkGrad(barCtx, '#1D4ED8', '#3B82F6'),
                        mkGrad(barCtx, '#0F766E', '#14B8A6'),
                    ],
                    borderRadius: 8,
                    borderSkipped: false,
                    maxBarThickness: 52,
            ...
            options: {
                ...
                plugins: {
                    ...
                    tooltip: {
                        ...
                        callbacks: {
                            ...
                            afterLabel: function() { return '  Click to view module'; }
                        }
                    }
                },
                scales: {
                ...
                onClick: function(e, els) {
                    if (els.length && barRoutes[els[0].index]) {
                        window.location.href = barRoutes[els[0].index];
                    }
                },
        ...
        function setupDropdown(toggleId, dropId) {
        ...
        setupDropdown('chartMenu1Toggle', 'chartMenu1Drop');
        setupDropdown('chartMenu2Toggle', 'chartMenu2Drop');
    </script>
@endsection