...
<head>
    ...
    <style>
        ...
        .navbar-vertical .nav-link:hover svg { stroke: var(--hope-gold); }
        ...
        .navbar-vertical .nav-link.active svg { stroke: var(--hope-green); }
        ...
        .sidebar-footer-btns { display: flex; gap: .4rem; }
...
<div class="page">
    ...
    <aside class="navbar navbar-vertical navbar-expand-lg" style="position:fixed;top:0;left:0;height:100vh;overflow-y:auto;z-index:200;display:flex;flex-direction:column;">
        ...
        <div class="sidebar-portal-tag">Guardian Portal</div>
        ...
        <div class="sidebar-user-footer">
            <div class="sidebar-user-card">
                ...
                <div>
                    ...
                    <div class="sidebar-user-role">Guardian</div>
                </div>
            </div>
            <div class="sidebar-footer-btns">
                <a href="{{ route('portal.profile.edit') }}" class="btn btn-sidebar-profile">
